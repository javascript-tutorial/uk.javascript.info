...
Але представлення атрибутів через властивості не відбувається один в один! У цій главі ми звернемо увагу на розрізнення цих двох понять, щоб побачити, як з ними працювати, коли вони співпадають і коли вони відрізняються.
...
Використання атрибутів `data-*` є валідним, безпечним способом передачі користувацьких даних.
