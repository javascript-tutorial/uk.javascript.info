...
Наприклад, така подія `DOMContentLoaded`, яке спрацьовує, коли завершено завантаження та побудова DOM документа.
...
Щоб правильно обробити подію, можуть знадобитися деталі того, що сталося. Не просто «клік» або «натискання клавіші», а також які координати вказівника миші, яка клавіша натиснута і так далі.
