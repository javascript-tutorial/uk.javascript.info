...
Функція повиння поставити запитання `question` і, залежно від відповіді користувача, викликати `yes()` або `no()`:
...
```smart header="Фунція -- це значення, що відображає \"дію\""
