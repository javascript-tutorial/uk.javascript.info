...
Все послідовності елементів повинні мати однакову ймовірність. Наприклад, `[1,2,3]` може бути перемішана як `[1,2,3]` або `[1,3,2]`, або `[3,1,2]` і т.д., з однаковою ймовірністю кожного випадку.
