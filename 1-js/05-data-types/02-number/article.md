...
В даному випадку знак підкреслення `_` відіграє роль "[синтаксичного цукору](https://en.wikipedia.org/wiki/Syntactic_sugar)", він робить число більш читабельним. Рушій JavaScript просто ігнорує `_` між цифрами, тому для нього це мільярд, як і в прикладі вище.
...
Існує спеціальний вбудований метод `Object.is`, який порівнює значення як `===`, але є більш надійним для двох виключних випадків:
