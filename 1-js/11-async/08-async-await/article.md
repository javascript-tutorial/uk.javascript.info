...
У разі помилки вона передаватиметься як зазвичай: від невдалого проміса до `Promise.all`, а потім стає помилкою, який ми можемо зловити за допомогою `try..catch` навколо виклику.
