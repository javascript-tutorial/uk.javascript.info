...
Ніхто не любить читати довгий горизонтальний рядок коду. Хорошую практикою є розподіляти його на декілька рядків.
...
let str = `
  ...
  науковців тощо, які працюють разом зі спільнотою 
...
Максимальну довжину рядку визначається командою. Зазвичай це `80` або `120` символів.
