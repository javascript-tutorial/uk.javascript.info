...
Коли ми бачимо`"..."` у коді це або параметри залишку, або синтаксис розширення.

Існує простий спосіб відрізнити їх:

- Коли `...` находиться в кінці параметрів функції, це "параметри залишку" і збирають решту списку аргументів у масив.
...
Усі аргументи виклику функції також доступні в олдскульному `arguments`: ітерабельному об'єкті, подібному до масиву.
