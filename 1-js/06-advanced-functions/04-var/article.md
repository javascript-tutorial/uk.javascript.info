...
var user = "Іван"; // це "var" нічого не робить (вже оголошено)
// ...Це не викликає помилки
...
Тут створюється і негайно викликається Function Expression. Таким чином, код виконується відразу і має власні приватні змінні.
