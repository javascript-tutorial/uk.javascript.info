...
Тривале опитування (Long polling) — це найпростіший спосіб мати постійне з’єднання із сервером, який не використовує жодного спеціального протоколу, такого як WebSocket або Server Side Events.
