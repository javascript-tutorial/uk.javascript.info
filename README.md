...
Папка називається `N-url`, де `N` - це число, яке використовується для сортування, а `URL` - частина URL-адреси з назвою матеріалу.
