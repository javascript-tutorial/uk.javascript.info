...
[![Перекладачі](https://img.shields.io/badge/all_contributors-27-orange.svg?style=flat-square)](#подяка-)
...
Якщо ви замітили неточності в перекладі, або ви знаєте нову інформацію, тоді, будь ласка, поділіться цим з іншими людьми (у вигляді запиту на злиття - PR, або створіть нове обговорення [тут](https://github.com/orgs/javascript-tutorial/teams/translate-uk/discussions)) 👏
