...
Деякі регулярні вирази виглядають простими, але можуть виконуватись дууууууже довгий час, та навіть змусити "зависнути" рушій JavaScript.
...
Чесно кажучи, відмітимо, що деякі рушії регулярних виразів можуть провести ефективно провести подібний пошук. Наприклад, версія рушію V8 починаючи з 8.8 здатна на це(тобто Google Chrome 88 не зависне), а Firefox все ж матиме проблеми.
