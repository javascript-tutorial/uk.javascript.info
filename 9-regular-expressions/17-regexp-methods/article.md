...
```js run
let str = 'Вітаю, світе!';
// Створюємо регулярний вираз, який охоплює будь-які слова, написані латиницею або кирилицею
let regexp = /[a-zA-Zа-яА-ЯіїєґІЇЄҐ]+/g; // без прапору "g", властивість lastIndex ігнорується
