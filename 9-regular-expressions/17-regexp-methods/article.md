...
Для пошуку літери, які написані кирилицею, слід увімкнути режим Unicode (`/u` в кінці виразу) та використовувати спеціальні властивості Unicode (`\p{L}`) для пошуку літер.
Якщо ж нам необхідно виконувати пошук слів, які написані латиницею, ми можемо використати `\w+` без увімкнення режиму Unicode. Тоді регулярний вираз буде таким: `/(\w+) (\w+)/`.
