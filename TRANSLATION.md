...
Якщо в перекладі потрібно згадати певний розділ, який є в перекладі, можна використати синтаксис `<info:object>`, де `object` -- це частина URL-адреси цього розділу.
На сайті, цей синтаксис буде замінено на посилання на розділ "Об’єкти".
